...
set psu_clock_init_data {
    ...
    mask_write 0XFF5E0100 0x013F3F07 0x01010402
    ...
    mask_write 0XFD1A0074 0x013F3F07 0x01013600
    ...
    mask_write 0XFD1A007C 0x013F3F07 0x01013200
...
set psu_ddr_init_data {
    ...
    mask_write 0XFD070100 0x7F3F7F3F 0x110C2412
		...
		#(OFFSET, MASK, VALUE)      (0XFD070104, 0x001F1F7FU ,0x0004041BU)  */
    mask_write 0XFD070104 0x001F1F7F 0x0004041B
...
set psu_post_config_data {
    ...
    mask_poll 0XFFD80110 0x00800000
}
