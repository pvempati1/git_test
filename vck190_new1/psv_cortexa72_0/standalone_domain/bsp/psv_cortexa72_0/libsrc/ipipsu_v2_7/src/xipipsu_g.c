...
XIpiPsu_Config XIpiPsu_ConfigTable[XPAR_XIPIPSU_NUM_INSTANCES] =
{
	...
	{
		XPAR_PSV_IPI_0_DEVICE_ID,
		XPAR_PSV_IPI_0_S_AXI_BASEADDR,
		XPAR_PSV_IPI_0_BIT_MASK,
		XPAR_PSV_IPI_0_BUFFER_INDEX,
		XPAR_PSV_IPI_0_INT_ID,
	...
	{
		XPAR_PSV_IPI_1_DEVICE_ID,
		XPAR_PSV_IPI_1_S_AXI_BASEADDR,
		XPAR_PSV_IPI_1_BIT_MASK,
		XPAR_PSV_IPI_1_BUFFER_INDEX,
		XPAR_PSV_IPI_1_INT_ID,
		XPAR_XIPIPSU_NUM_TARGETS,
		{
	...
	{
		XPAR_PSV_IPI_2_DEVICE_ID,
		XPAR_PSV_IPI_2_S_AXI_BASEADDR,
		XPAR_PSV_IPI_2_BIT_MASK,
		XPAR_PSV_IPI_2_BUFFER_INDEX,
		XPAR_PSV_IPI_2_INT_ID,
		XPAR_XIPIPSU_NUM_TARGETS,
		{
	...
	{
		XPAR_PSV_IPI_3_DEVICE_ID,
		XPAR_PSV_IPI_3_S_AXI_BASEADDR,
		XPAR_PSV_IPI_3_BIT_MASK,
		XPAR_PSV_IPI_3_BUFFER_INDEX,
		XPAR_PSV_IPI_3_INT_ID,
		XPAR_XIPIPSU_NUM_TARGETS,
		{
	...
	{
		XPAR_PSV_IPI_4_DEVICE_ID,
		XPAR_PSV_IPI_4_S_AXI_BASEADDR,
		XPAR_PSV_IPI_4_BIT_MASK,
		XPAR_PSV_IPI_4_BUFFER_INDEX,
		XPAR_PSV_IPI_4_INT_ID,
		XPAR_XIPIPSU_NUM_TARGETS,
		{
	...
	{
		XPAR_PSV_IPI_5_DEVICE_ID,
		XPAR_PSV_IPI_5_S_AXI_BASEADDR,
		XPAR_PSV_IPI_5_BIT_MASK,
		XPAR_PSV_IPI_5_BUFFER_INDEX,
		XPAR_PSV_IPI_5_INT_ID,
		XPAR_XIPIPSU_NUM_TARGETS,
		{
	...
	{
		XPAR_PSV_IPI_6_DEVICE_ID,
		XPAR_PSV_IPI_6_S_AXI_BASEADDR,
		XPAR_PSV_IPI_6_BIT_MASK,
		XPAR_PSV_IPI_6_BUFFER_INDEX,
		XPAR_PSV_IPI_6_INT_ID,
		XPAR_XIPIPSU_NUM_TARGETS,
		{
